...
def test_get_x_center_position_title():
    ...
    x = layout.get_x_center_position_title()
    assert x == 800


def test_get_y_center_position_title():
    layout = Layout(width=1600, height=800)
    x = layout.get_y_center_position_title()
    assert x == 40


def test_get_x_center_position_home():
    layout = Layout(width=1600, height=800)
    x = layout.get_x_center_position_home()
    assert x == 400


def test_get_x_center_position_away():
    layout = Layout(width=1600, height=800)
    x = layout.get_x_center_position_away()
    assert x == 1200
...
def test_get_x_position_home():
    layout = Layout(width=1600, height=800)
    text = Surface(100, 50)
    x = layout.get_x_position_home(text)
    assert x == (400 - 100 / 2)
...
def test_get_team_name_y_position():
    layout = Layout(width=1000, height=800)
    text = Surface(100, 50)
    y = layout.get_team_name_y_position(text)
    assert y == (350 - 50 / 2)
...
def test_get_team_logo_y_position():
    ...
    y = layout.get_team_logo_y_position(logo)
    assert y == (200 - 100 / 2)
...
def test_get_team_score_y_position():
    layout = Layout(width=1000, height=800)
    text = Surface(100, 80)
    y = layout.get_team_score_y_position(text)
    assert y == (500 - 80 / 2)
...
def test_get_team_set_score_y_position():
    layout = Layout(width=1000, height=800)
    text = Surface(100, 40)
    y = layout.get_team_set_score_y_position(text)
    assert y == (700 - 40 / 2)
